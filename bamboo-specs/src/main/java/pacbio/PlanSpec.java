...
public class PlanSpec {
    ...
    public Plan plan() {
        final Plan plan = new Plan(new Project()
            ...
            "falcon3",
            new BambooKey("FALCON3"))
            .description("Plan created from Bamboo Java Specs,  modify http://bitbucket.pacificbiosciences.com:7990/projects/SAT/repos/falcon3/browse project to update the plan.")
